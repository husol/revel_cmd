...
import (
	...
	"github.com/husol/revel_cmd"
	"github.com/husol/revel_cmd/model"
	"github.com/husol/revel_cmd/utils"
)
...
func (v *VersionCommand) doRepoCheck(updateLibs bool) (versionInfo string, needsUpdate bool) {
	...
	for _, repo := range []string{"revel", "cmd", "modules"} {
		...
		case "cmd":
			title, repo, localVersion = "Revel Cmd", "github.com/husol/revel_cmd/revel", v.cmdVersion
		case "modules":
